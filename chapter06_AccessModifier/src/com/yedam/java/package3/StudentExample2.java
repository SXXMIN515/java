	...
	public static void main(String[] args) {
		...
		while (run) {
			...
			if (selectNo == 1) { // 학생수 입력 => 배열의 크기
				 ...
				 */
				MaxScore2 korMax = new MaxScore2(0, scoreList[0].getKoreanScore());
				MaxScore2 mathMax = new MaxScore2(0, scoreList[0].getMathScore());
				MaxScore2 engMax = new MaxScore2(0, scoreList[0].getEnglishScore());
